...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, MOTOR_X_STEP_Pin|MOTOR_X_MS1_Pin|MOTOR_X_MS2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MOTOR_X_STEP_Pin MOTOR_X_MS1_Pin MOTOR_X_MS2_Pin */
  GPIO_InitStruct.Pin = MOTOR_X_STEP_Pin|MOTOR_X_MS1_Pin|MOTOR_X_MS2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : MOTOR_X_EN_Pin */
